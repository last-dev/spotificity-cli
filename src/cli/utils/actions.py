...
from ui.colors import RED, GREEN, RESET, YELLOW
...
def get_api_endpoint() -> str:
    ...
    try:
        ...
        print(f'{RED}Client Error Message: {err.response["Error"]["Message"]}')
        print(f'{RED}Client Error Code: {err.response["Error"]["Code"]}')
